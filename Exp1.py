def conversion(a):
    #returns a binary string of a number which has bits equal to count
    q=""
    current_n = len(a)
...
def add(x,y):
    #fun to add two binary number strings
...
y = int(input()) #taking x and y decimal numbers as input for x * y
a = bin(x).replace("0b", "")
b = bin(y).replace("0b", "")
negative_a=0
negative_b=0
...
count1 = count
firstP = conversion(a)
#contains the positive representation of the multiplicand

secondP = conversion(b)
#contains the positive representation of the multiplier

firstN = twoc(firstP)
#contains 2's complement of the multiplicand

secondN = twoc(secondP)
#contains 2's complement of the multiplier
